...
var Container = function (_PureComponent) {
  ...
  function Container() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Container.__proto__ || Object.getPrototypeOf(Container)).call.apply(_ref, [this].concat(args))), _this), _this.events = ['resize', 'scroll', 'touchstart', 'touchmove', 'touchend', 'pageshow', 'load', 'thirdPartyScroll'], _this.subscribers = [], _this.subscribe = function (handler) {
